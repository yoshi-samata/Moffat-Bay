    ...
    <main>
        <section class="dashboard">
            <div class="dashboard-options">
                <button onclick="window.location.href='userdashhome.php';">Dashboard Home</button>
                <button onclick="window.location.href='reservation.php';">Make a Reservation</button>
                <button onclick="window.location.href='userdashviewres.php';">View Reservation</button>
                <button onclick="window.location.href='waitlistview.php';">View Waitlist</button>
